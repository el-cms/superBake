# About this plugin
## Backstory
I created superBake because I was discovering CakePHP in its version 2.1. There was no way for me 
to easily bake all my models, views and controllers with all the prefixes support, a good internationalization support
( `__d() and __()` depending on the plugin I was working on), no menu generation. So I decided to create something that can do all that,
based on a configuration file (yes, I know, Cake is powerfull *without* a configuration file...)
 ...
 * IDE/Softwares
  * I like to work with [netBeans for PHP](https://netbeans.org/downloads/) and this plugin: [CakePHP for Netbeans](http://plugins.netbeans.org/plugin/44579/php-cakephp-framework)
