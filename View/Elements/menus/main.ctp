...
<li class="dropdown">
	...
	<ul class="dropdown-menu">
		...
		<!-- Config -->
		<li role="presentation" class="divider"></li>
		<li role="presentation" class="dropdown-header"><i class="icon-cog"></i> <?php echo __d('sb', 'Configuration file') ?></li>
		...
		<!-- Templates -->
		<li role="presentation" class="divider"></li>
		<li role="presentation" class="dropdown-header"><i class="icon-cog"></i> <?php echo __d('sb', 'Templates') ?></li>
		...
		<!-- The shell -->
		<li role="presentation" class="divider"></li>
		<li role="presentation" class="dropdown-header"><i class="icon-cog"></i> <?php echo __d('sb', 'Shell') ?></li>
