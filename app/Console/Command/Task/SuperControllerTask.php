...
class SuperControllerTask extends BakeTask {
	...
	/**
	 * Current Model name. Can be null
	 * @var string
	 */
...
//		$controller = $this->currentModel;
		...
		$this->out(__d('cake_console', 'Baking public actions for ') . $controller);
	...
	public function bakeActions($controllerName, $admin = null, $wannaUseSession = true) {
		...
		// By default, create actions from model
		if ($this->currentControllerConfig['hasModel'] == true) {
			//$controllerTemplate='controller_actions';
