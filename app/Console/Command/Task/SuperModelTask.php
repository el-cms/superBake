...
//	public $skipTables = array('i18n');
	...
	/**
	 * Current plugin name. Null for no plugin.
	 * @var string
	 */
...
//	}
	...
	public function bake($name, $data = array()) {
		...
		$defaults = array(
			...
			'useTable' => null,
			'useDbConfig' => 'default',
			'displayField' => $this->currentModelConfig['displayField'],
		);
		//$options = $this->currentModelConfig;
		...
		// Giving project Config to template
