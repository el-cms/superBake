...
<?php if ($wannaUseSession): ?>
			$this->Session->setFlash(<?php echo $this->display(ucfirst(strtolower($singularHumanName)).' deleted')?>, 'flash_success');
...
<?php if ($wannaUseSession): ?>
		$this->Session->setFlash(<?php echo $this->display(ucfirst(strtolower($singularHumanName)).' was not deleted')?>, 'flash_error');
<?php else: ?>
