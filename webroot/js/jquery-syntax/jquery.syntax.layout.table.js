...
Syntax.layouts.table = function(options, code, container) {
	...
	a = jQuery('<a href="#" class="btn btn-xs btn-info"><i class="icon-eye-open"></i> View Raw Code</a>');
	...
	toolbar.append(a);
	toolbar.append('<a href="http://www.oriontransfer.co.nz/software/jquery-syntax" class="btn btn-xs btn-info" target="oriontransfer"><i class="icon-question-sign"></i></a>');
